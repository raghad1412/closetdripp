...
export default function LookbookScreen() {
  ...
  return (
    <SafeAreaView style={s.root}>
      ...
      {/* Header */}
      <View style={s.header}>
        <TouchableOpacity style={s.backBtn} onPress={() => step === "pick" ? setStep("name") : router.back()}>
      ...
      {step === "name" && (
        <View style={s.nameStep}>
          ...
          <Text style={s.stepSubtitle}>Give it a theme like "Summer Fits" or "Work Looks"</Text>
          ...
          <View style={s.suggestRow}>
            {["Summer Fits","Work Looks","Date Night","Casual Vibes","Going Out","Cosy Season"].map(s => (
              <TouchableOpacity key={s} style={s2.chip} onPress={() => setName(s)}>
        ...
        <>
          ...
          {items.length === 0 ? (
            <View style={s.emptyState}>
              ...
              <Text style={s.emptySubtitle}>Add items to your wardrobe first</Text>
            </View>
          ) : (
            <FlatList
              data={items}
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <TouchableOpacity
                    style={[s.gridItem, { backgroundColor: item.bg }, isSelected && s.gridItemSelected]}
...
const s2 = StyleSheet.create({
  chip:     { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1.5, borderColor: "#e8e8e8", backgroundColor: "#fafafa", marginRight: 8, marginBottom: 8 },
...
const s = StyleSheet.create({
  ...
  saveBtn:        { backgroundColor: PINK, borderRadius: 20, paddingHorizontal: 20, paddingVertical: 8 },
  ...
  nameInput:      { borderWidth: 1.5, borderColor: "#ebebeb", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, fontSize: 17, color: "#1a1a1a", backgroundColor: "#fff", marginBottom: 28 },
  suggestLabel:   { fontSize: 12, color: "#aaa", fontWeight: "600", letterSpacing: 0.5, marginBottom: 12, textTransform: "uppercase" },
  suggestRow:     { flexDirection: "row", flexWrap: "wrap" },

  pickHeader:     { paddingHorizontal: 16, paddingVertical: 14, backgroundColor: "#fff", borderBottomWidth: 1, borderBottomColor: "#f0f0f0" },
  ...
  gridItem:       { width: ITEM_SIZE, height: ITEM_SIZE, borderRadius: 12, overflow: "hidden", alignItems: "center", justifyContent: "center" },
  gridItemSelected:{ borderWidth: 3, borderColor: PINK },
  gridImg:        { width: "100%", height: "100%" },
  gridEmoji:      { fontSize: 36 },
  gridLabel:      { position: "absolute", bottom: 4, fontSize: 9, color: "#999", paddingHorizontal: 4, textAlign: "center" },
  checkOverlay:   { ...StyleSheet.absoluteFillObject as any, backgroundColor: "rgba(255,255,255,0.5)", alignItems: "center", justifyContent: "center" },
